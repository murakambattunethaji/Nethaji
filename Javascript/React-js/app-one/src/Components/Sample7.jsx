...
const Sample7 = () => {
    ...
    const getAllContactsFromServer = async () => {
        const response = await fetch("http://localhost:4200/contact");
    ...
    const deleteContact = async (contact) => {
        const response = await fetch(
            "http://localhost:4200/contact" + contact.id,
            {
                method: "DELETE",
            }
        );
    ...
    const updateContactInServer = async () => {
        const response = await fetch("http://localhost:4200/contact" + address.id, {
            method: "PUT",
            body: JSON.stringify(address),
            headers: { "Content-Type": "application/json" },
        })
